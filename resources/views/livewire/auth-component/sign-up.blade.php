        ...
        <div class="col-lg-11 col-md-11">
            <div class="card shadow-sm">
                <div class="card-body d-flex justify-content-center align-items-stretch p-0">
                    ...
                    <div class="col-lg-6 col-md-6 bg-dark text-light p-4">
                        <form wire:submit='store' method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" wire:model='profileImg'>
                            </div>

                            @if ($profileImg)
                                <div class="mb-3">
                                    <img src="{{ $profileImg->temporaryUrl() }}" alt="Preview Image"
                                        class="object-fit-contain shadow" style="width:50px;height:50px;">
                                </div>
                            @endif
